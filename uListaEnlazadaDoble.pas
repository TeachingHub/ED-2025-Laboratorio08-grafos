...
type
    ...
    function first(list: tListaDoble): string;
    function last(list: tListaDoble): string;
    procedure insert_at_end(var list: tListaDoble; x: string);
    procedure insert_at_begin(var list: tListaDoble; x: string);
    procedure delete_at_end(var list: tListaDoble);
    procedure delete_at_begin(var list: tListaDoble);
    function in_list(list: tListaDoble; x: string): boolean;
...
implementation
    ...
    begin
        ...
        while aux <> nil do
        begin
            s := s + (aux^.info) + ' '; // Agrega la información del nodo a la cadena
            aux := aux^.sig; // Avanza al siguiente nodo
        end;
