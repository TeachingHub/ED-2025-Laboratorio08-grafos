...
type
    ...
    function first(list: tListaSimple): string;
    function last(list: tListaSimple): string;
    procedure insert_at_end(var list: tListaSimple; x: string);
    procedure insert_at_begin(var list: tListaSimple; x: string);
    procedure delete_at_end(var list: tListaSimple);
    procedure delete_at_begin(var list: tListaSimple);
    procedure delete(var list: tListaSimple; x: string);
    function in_list(list: tListaSimple; x: string): boolean;
    function rec_in_list(list: tListaSimple; x: string): boolean;
